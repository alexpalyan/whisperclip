# Context: Phase 10 — Mutable Data Model + Diarizer Micro-Windows
...
2. **Plan 10-01:** Міграція `MeetingSegment` на клас та впровадження UUID.
3. **Plan 10-02:** Налаштування мікро-вікон у `DiarizerManager`.
